...
public class Security extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/users/signup", "/refresh/**").permitAll();
        http.authorizeRequests().antMatchers(GET, "/products/**", "/users/**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN");
